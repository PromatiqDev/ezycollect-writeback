...
namespace SageComAPI
{
    class TestSageModule
    {
        ...
        public TestSageModule(string appid, string programnane, string appversion, string erpuser, string erppassword, string companyid, string systemid)
        {
            try
            {
                APPID = appid;
        ...
        public string InsertReceipt(string CustomerCode, string InvoiceNumber, decimal PaymentAmount, bool PrintOption)
        {
            string Response = "";
            if (LogEvents == null)
                LogEvents = new List<string>();
            ...
            try
            {
                ...
                if (Outstanding < 0)
                {
                    ...
                    if (InvoiceNumber != "")
                    {
                        ...
                        Response += "Error reading invoice due amount: " + ReadOutstandingResult + ". ";
                    }
                }
                else
                {
                    ...
                    Response += "Getting amount to apply: " + AppliedAmount.ToString() + ". ";
                }
        ...
        public string InsertCreditReceipt(string CustomerCode, string InvoiceNumber,string CreditNotenumber, decimal PaymentAmount)
        {
            string Response = "";
            if (LogEvents == null)
                LogEvents = new List<string>();
            ...
            try
            {
                ...
                Response += _clsSAGE.InsertCreditBatch(CustomerCode, InvoiceNumber, CreditNotenumber, AppliedAmount);
        ...
        public string InsertCreditNote(string CustomerCode, string InvoiceNumber,string CreditNoteRef, decimal InvoiceAmount)
        {
            string Response = "";
            if (LogEvents == null)
                LogEvents = new List<string>();
            ...
            try
            {
                ...
                {
                    //get the balance to apply
                    if (InvoiceAmount > Outstanding || InvoiceAmount == 0)
                        AppliedAmount = Outstanding;
                    else
                        AppliedAmount = InvoiceAmount;
                ...
                Response += _clsSAGE.InsertCreditNote(CustomerCode, InvoiceNumber, CreditNoteRef);
